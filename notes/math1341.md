...
<div style='width: 100%' class='ui rounded images'>
<img class='ui image' src='/notes/math1341/lec30-fig1.png'>
</div>
...
<div style='width: 100%' class='ui rounded images'>
<img class='ui image' src='/notes/math1341/lec30-fig2.png'>
</div>
...
<div style='width: 100%' class='ui rounded images'>
<img class='ui image' src='/notes/math1341/lec30-fig3.png'>
</div>
...
<div style='width: 100%' class='ui rounded images'>
<img class='ui image' src='/notes/math1341/lec31-fig1.png'>
</div>
...
<div style='width: 100%' class='ui rounded images'>
<img class='ui image' src='/notes/math1341/lec31-fig2.png'>
</div>
...
<div style='width: 100%' class='ui rounded images'>
<img class='ui image' src='/notes/math1341/lec31-fig3.png'>
</div>
...
<div style='width: 100%' class='ui rounded images'>
<img class='ui image' src='/notes/math1341/lec31-fig4.png'>
</div>

$\int_{a}^{b} k dx = k (b - a)$ (height times width of interval)
 
<div style='width: 100%' class='ui rounded images'>
<img class='ui image' src='/notes/math1341/lec31-fig5.png'>
</div>
...
<div style='width: 100%' class='ui rounded images'>
<img class='ui image' src='/notes/math1341/lec31-fig6.png'>
</div>
...
<div style='width: 100%' class='ui rounded images'>
<img class='ui image' src='/notes/math1341/lec31-fig7.png'>
</div>
...
<div class="note-block">
<strong class="note-block">Proposition:</strong>
...
<div style='width: 100%' class='ui rounded images'>
<img class='ui image' src='/notes/math1341/lec31-fig8.png'>
</div>

So $(A_f)(b-a) = \int_{a}^{b} f(x) dx$

<div class="note-block">
<strong class="note-block">Mean Value Theorem for Integration:</strong>
...
<div style='width: 100%' class='ui rounded images'>
<img class='ui image' src='/notes/math1341/lec31-fig9.png'>
</div>
...
1. The function $G(x) = \int_{a}^{x} f(t) dt$ is an anti-derivative of $f$ on [a, b].
    * $\left( \int_{a}^{x} f(t) dt \right)' = G'(x) = f(x)$
    * Continuous functions have anti-derivatives 
2. If $F(x)$ is any anti-derivative of our function $f$ on [a, b], then 
...
<div style='width: 100%' class='ui rounded images'>
<img class='ui image' src='/notes/math1341/lec33-fig1.png'>
</div>
...
<div style='width: 100%' class='ui rounded images'>
<img class='ui image' src='/notes/math1341/lec33-fig2.png'>
</div>
...
<div style='width: 100%' class='ui rounded images'>
<img class='ui image' src='/notes/math1341/lec33-fig3.png'>
</div>
...
<div style='width: 100%' class='ui rounded images'>
<img class='ui image' src='/notes/math1341/lec34-fig1.png'>
</div>
...
<div style='width: 100%' class='ui rounded images'>
<img class='ui image' src='/notes/math1341/lec34-fig2.png'>
</div>
...
We can get rid of the similarity $e^{x^2}$ and we are left with  $f(x) = e^{-x}$
and $g(x) = e^{-3x+4}$
...
Three ways to solve
1. Solve for x. Results in a square root
2. Swap x and y including axes
3. Let y be the integration variable 
